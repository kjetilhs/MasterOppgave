...
\end{figure}
\subsection{Software in the loop simulation}\label{ss:SILLandingPlan}
...
\end{figure}
\subsubsection{Landing plan generation}
...
\end{figure}
\subsubsection{Spiral path creation}
...
\end{figure}
\subsubsection{Result of simulations}\label{SIL:Results}
