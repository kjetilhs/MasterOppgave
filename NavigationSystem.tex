...
To ease monitoring of the navigation system a interface has been created in  Neptus, which display the current navigation source that is used and which is available.
